...
function getListOfChannels() {
  ...
  switch (channelOptions.value) {
    case "globo":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_GLOBO_SP/video.m3u8?token=01b6146097c9e0841e696bba239af043";
    ...
    case "globo hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_GLOBO_SP/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;

    case "band":
      channel.value =
        "https://evpp.mm.uol.com.br/geob_band/app/chunklist_w2109694991.m3u8";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "cartoon network 2":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_CARTOON_NETWORK/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;

    case "rdc":
      channel.value =
        "https://5a7d54e35f9d2.streamlock.net/rdctv/smil:rdctv.smil/chunklist_w891027107_b1000000.m3u8";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "redetv":
      channel.value =
        "https://evpp.mm.uol.com.br/redetv1/redetv1/chunklist_w1956210905.m3u8";
      titleCard.innerText = channelOptions.value;
      break;

    case "tv cultura":
      channel.value =
        "http://wowza4.catve.com.br:1935/live/livestream/chunklist_w1766700799.m3u8";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "nickelodeon":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_NICKELODEON/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "dazn 1":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_DAZN_1/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "dazn 2":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_DAZN_2/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "in paradise":
      channel.value =
        "https://cdn.jmvstream.com/w/inpara/_definst_/inpara/chunklist_w1305866021.m3u8?fluxustv.m3u8";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "animal planet":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_ANIMAL_PLANET/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "a e e":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_AE/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "discovery channel":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_DISCOVERY/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "discovery home e health":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_DISCOVERY_HOMEHEALTH/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "band sports":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_BAND_SPORTS/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "discovery kids":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_DISCOVERY_KIDS/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "telecine premium":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_TC_PREMIUM/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "e!":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_E/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "e! hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_E/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "espn":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_ESPN/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "fox":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_FOX/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "fox hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/FHD_FOX/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "fox sports":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_FOX_SPORTS/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "gloob":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_GLOOB/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "gloobinho":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_GLOOBINHO/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "gnt":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_GNT/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "hbo":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_HBO/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "megapix":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_MEGAPIX/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "natgeo kids":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_NATGEOKIDS/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "natgeo wild":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_NAT_GEO_WILD/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "premiere":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_PFC_2/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "sport tv":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_SPORTV_1/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "syfy":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_SYFY/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "syfy hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_SYFY/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "history channel":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_HISTORY/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "history channel hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/FHD_H2/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "boomerang":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/SD_BOOMERANG/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
    ...
    case "boomerang hd":
      // inconsistente
      channel.value =
        "http://lb.kstream.org/aovivo/HD_BOOMERANG/video.m3u8?token=01b6146097c9e0841e696bba239af043";
      titleCard.innerText = channelOptions.value;
      break;
